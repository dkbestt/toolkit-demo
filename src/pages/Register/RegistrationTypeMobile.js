...
const RegisterTypeMobile = () => {
    ...
    const sendOTPCode = () => {
        ...
        dispatch(addRegistrationMobileData(mobileData))
        OTPSendVerify(phone)
    }
                ...
                formik => {
                    return (
                        <Form>
                            <div className='flex  w-96'>
                                <div className="relative pb-5">
                                    <div className='pt-3'>
                                        ...
                                        />
                                        <button
                                            className="absolute bottom-8 top-1 right-1 text-[#619cb0]"
                                            type='button'
                                            name='sendCode'
                                            onClick={sendOTPCode}
                                        >
                            ...
                            {
                                isSend && (<UserVerify {...{ disabled, setDisabled, validationMsg, setValidationMsg, sendOTPCode, isSend }} />)
                            }
